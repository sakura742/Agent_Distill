...
class Settings:
    ...
    retrieval_hybrid: bool = field(default_factory=lambda: _env("AGENT_DISTILL_RETRIEVAL_HYBRID", "0") == "1")
    retrieval_query_rewrite: bool = field(default_factory=lambda: _env("AGENT_DISTILL_RETRIEVAL_QUERY_REWRITE", "1") == "1")
    retrieval_rerank_weight: float = field(default_factory=lambda: _env_float("AGENT_DISTILL_RETRIEVAL_RERANK_WEIGHT", 0.70))
